function initializeMenu() {
    ...
    // toggles para submenu (accesible en móvil)
...
// inicializa automáticamente si el header ya está presente al cargar
document.addEventListener('DOMContentLoaded', initializeMenu);
// Exponer globalmente para poder llamarlo después de cargar header dinámico
